...
POST_url = "https://lilly.wd5.myworkdayjobs.com/wday/cxs/lilly/LLY/jobs"
ind_job_url = "https://lilly.wd5.myworkdayjobs.com/en-US/LLY/details/"
...
def send_email_report(df):
    ...
    msg = EmailMessage()
    msg['Subject'] = f"Eli Lilly Workday Jobs Report – {datetime.now().strftime('%Y-%m-%d')}"
